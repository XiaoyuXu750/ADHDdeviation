...
We investigated these questions across two large cohorts: the U.S. [Adolescent Brain Cognitive Development study](https://abcdstudy.org/) (6,687 typically developing and 1,114 ADHD scans) and an independent Chinese cohort (292 typically developing and 468 ADHD participants). The Chinese cohort consist of two studies, EFNY (Executive Function and Neurodevelopment in Youth) and PKU6 (Peking University Sixth Hospital). Data of these two datasets are not yet available, as collection is still ongoing.
